...
class Todo {
    constructor(title, dueDate, projectId, description = '', priority = '', notes = '') {
        ...
        this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dueDate), 'dd-MM-yyyy');
