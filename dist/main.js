...
addTodoButton.addEventListener("click", () => {
    ...
    let newTodo = new _src_components_todos__WEBPACK_IMPORTED_MODULE_1__.Todo(todoTitle, todoDescription, todoDueDate, todoPriority, todoNotes);
    selectedProject.todos.push(newTodo);
    (0,_src_components_storage__WEBPACK_IMPORTED_MODULE_2__.saveProject)(selectedProject)
})
...
makeButton.addEventListener('click', () => {
    ...
    if (!projectNames.includes(inputField.value)) {
        let newProject = new _src_components_projects__WEBPACK_IMPORTED_MODULE_0__.Project(inputField.value);
        (0,_src_components_storage__WEBPACK_IMPORTED_MODULE_2__.saveProject)(newProject);
    } else {
