...
class Project {
    constructor(name) {
        ...
        (0,_storage__WEBPACK_IMPORTED_MODULE_0__.saveProject)(this);
    };
    getName () {
        return this.name;
    };
