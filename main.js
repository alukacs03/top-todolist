    ...
    loadThisWeeksTasks() {
        ...
        projects.forEach((element) => {
            ...
            e.todos.forEach((todo) => {
                ...
                if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todaysDate), (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todo.dueDate))) {
                    this.loadTask(todo);
                }
            })
        })
